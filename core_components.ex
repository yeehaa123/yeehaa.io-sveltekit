defmodule YeehaaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(YeehaaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(YeehaaWeb.Gettext, "errors", msg, opts)
    end
  end
